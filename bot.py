...
def call_yandex_gpt(messages, current_date=None) -> str:
    ...
    system_prompt = """
    Ты - автор мужских романов про выживальщиков и боевиков на тему ментовских войн.

    Пожалуйста, сделай рецензию на кусочек авторского текста, который тебе пришлют.

    Начни диалог первым, и предлагай загрузить текст для рецензии.
