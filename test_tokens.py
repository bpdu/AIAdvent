...
Используется БЕСПЛАТНАЯ модель qwen/qwen-2.5-7b-instruct:free
"""
...
MODEL_NAME = 'qwen/qwen-2.5-7b-instruct:free'  # Free model
...
def main():
    ...
    4. Бесплатная модель Qwen от OpenRouter отлично работает!
