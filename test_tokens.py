...
Используется БЕСПЛАТНАЯ модель meta-llama/llama-3.2-3b-instruct:free (3B параметров от Meta)
"""
...
def main():
    ...
    print("   (БЕСПЛАТНАЯ МОДЕЛЬ LLAMA 3.2 - 3B от Meta)")
    print("="*60)
    ...
    4. Бесплатная модель Llama 3.2 от Meta через OpenRouter отлично работает!
